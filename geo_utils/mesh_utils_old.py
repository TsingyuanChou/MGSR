...
class GaussianExtractor(object):
    ...
    def extract_mesh_unbounded(self, resolution=1024):
        ...
        from geo_utils.render_utils import transform_poses_pca, focus_point_fn
        ...
        from geo_utils.mcube_utils import marching_cubes_with_contraction
    ...
    def export_image(self, path):
        ...
        for idx, viewpoint_cam in tqdm(enumerate(self.viewpoint_stack), desc="export images"):
            ...
            save_img_f32(self.depthmaps[idx][0].cpu().numpy(), os.path.join(vis_path, 'depth_{0:05d}'.format(idx) + ".png"))
